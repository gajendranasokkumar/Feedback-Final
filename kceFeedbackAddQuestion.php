<?php 
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (isset($_POST['input_id'])) {
            ...
            $i = 1;
            while ($i<=20) {
                $tableCreateQuery .= "q$i VARCHAR(200), ";
...
<head>
    ...
    <title>Add Questions to Database</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-11 col-lg-10 title_bar">
                <div class="arrow" onclick="window.location.assign('admin.php');">
        ...
        <form action="kceFeedbackAddQuestion.php" method="post" id="addQuestionForm">
        <div class="row">
